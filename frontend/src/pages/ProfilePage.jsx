              ...
              {isEmployee && (
                <>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    ...
                    <div>
                      <span style={{ display: "block", fontSize: "11px", color: "var(--text-muted)" }}>Date of Joining</span>
                      <span style={{ fontSize: "14px", fontWeight: 500, color: "var(--text-primary)" }}>
                        {user.joiningDate ? new Date(user.joiningDate).toLocaleDateString(undefined, { dateStyle: "long" }) : "—"}
                      </span>
                    </div>
                  </div>
                </>
